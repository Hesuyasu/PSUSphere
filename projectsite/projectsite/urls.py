...
urlpatterns = [
    ...
    path("organization_list/<pk>/delete",
         OrganizationDeleteView.as_view(), name="organization-delete"),
    ...
    path("orgmember_list/<pk>/delete",
         OrgMemberDeleteView.as_view(), name="orgmember-delete"),
    ...
    path("college_list/<pk>/delete",
         CollegeDeleteView.as_view(), name="college-delete"),
