...
SECRET_KEY = 'django-insecure-&@x)p6lfc_h)0t)n8^)i3xofxtzai3i!85d8x-k-m(=%lct1ax'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'EDPsusphere.pythonanywhere.com']
...
PWA_APP_NAME = 'Psusphere'
PWA_APP_DESCRIPTION = "A Progressive Web App version of Psusphere"
